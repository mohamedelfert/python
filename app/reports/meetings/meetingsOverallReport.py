...
def meetingsOverallReport():
    ...
    for user_id in users_ids:
        ...
        total_figures = {
            "scheduled_meetings": 0, "meetings_feedbacks": 0, "pending_meetings": 0,
            "canceled_deferred_meetings": 0, "new_converted_deals": 0, "attended_meetings": 0
        }
        ...
        for record in records:
            ...
            if "Figures" in record:
                for figure in record["Figures"]:
                    ...
                    elif figure_name == 'attended_meetings':
                        break
